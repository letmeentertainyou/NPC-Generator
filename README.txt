...
You may use your own tables as drop in replacements for everything except jobs.txt and race.txt because
those tables have hardcoded bonuses. I will explain how to expand that part of the code in another document.

To use simply run:
$ python3 NPC.py

Without any arguments a level one character will be created. You can also give a single integer as an argument:
$ python3 NPC.py 20

To generate a character at that level.

Note that this program needs to be in the same directory as the tables/ directory or nothing will happen.

---

For my private games I am using some custom tables not provided in this repo. I do not have the rights
to publish those tables so I provided some very short example tables instead. 

I do have the ability to link you to the custom tables I used and you can do with those links what you wish!
